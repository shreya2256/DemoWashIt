...
export default function DeliveredMyOrdersPage() {
...
<>
<Helmet >
<title>Delivered Orders - Review Your TechVolt Purchases</title> 
<meta
name="description"
content="Review your delivered orders from TechVolt. Confirm receipt, write reviews, and check return policies for your high-capacity, innovative tech products."
/>
</Helmet>
...
<Text size="text2x1" as="p" className="tracking-[1.40px] Itext-black-900_02">
...
className="flex h-[56px] min-w-[224px] cursor-pointer flex-row items-center justify-center whitespace-pre-wrap rounded- 16px border border-solid border-black+900 02 be-white-a700 px-7 text-center text- 16px) text-black-900 02 sm:px-5"
> 
<span>{option.label}</span>
    ...
    <div
    onClick={option.toggle}
    className="flex h-[56px] min-w-[224px] cursor-pointer flex-row items-center justify-center rounded-[16px) border border-solid border-blue _gray-100_01 bg-white-a700 px-7 text-center text-[16px) text-gray-700 sm:px-5"
    >
    <span> {option.label}</span>
    </div>
    )}
    ...
    <Text size="text2xl" as="p" className="m1-10 tracking-[1.40px] |text-black-900_02 sm:m1-0">
Canceled & returned
</Text>
</div>
<div className="flex w-[36%] items-center justify-end gap-2 md:w-full">
<Text size="text2x1" as="p" className="self-end !font-medium !text-black-900_02">
Sort by:
</Text>
<SelectBox
size="xs"
...
<div className="flex flex-col gap-6">
<OrderDetails1 className="rounded-[16px] border border-solid border-gray-300_02 bg-white-a700" />
<OrderDetails1 />
</div>
</div>
</div>
